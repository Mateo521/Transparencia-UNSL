...
class Tailwind_Nav_Walker extends Walker_Nav_Menu
{
    ...
    function start_el(&$output, $item, $depth = 0, $args = null, $id = 0)
    {
        ...
        if ($has_children) {
            ...
            if ($depth == 0) {
                $item_output .= '<svg class="dropdown-icon w-4 h-4 ml-1 opacity-70 transition-transform duration-300 transform" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" /></svg>';
            } else {
                $item_output .= '<svg class="dropdown-icon w-4 h-4 ml-1 opacity-70 transition-transform duration-300 transform md:-rotate-90" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" /></svg>';
            }
        }
